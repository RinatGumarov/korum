...
class Demand {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _serializer.uint32(obj.validatorFee, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.validatorFee = _deserializer.uint32(buffer, bufferOffset);
  ...
  static Resolve(msg) {
    ...
    const resolved = new Demand(null);
